...
TextInputText и PlanEditPage обмениваются данными и сообщениями через обработчик в
java-стиле:
...
Не изящно, неужели нет другого способа через emit событий или watch?

Основная проблема, похоже в неправильной организации - компонент PlanEditPage показывает
данные, но не управляет их загрузкой.
