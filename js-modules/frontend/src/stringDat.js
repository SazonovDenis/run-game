let stringDat = {
    ...
    "help.plan.maskAnswer": "Переводы скрыты для заучивания и повторения слов.<div class='help-br'>&nbsp;</div>Постарайтесь сами вспомнить ответ. Чтобы 'подсмотреть' перевод слова, нажмите на него.",
