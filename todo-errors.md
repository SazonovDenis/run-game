...
Указание пользователя - некорректно, ведь идменение ОДНОГО плана (например: общего или
...
**ok** Слишком много повторений при ошибке - напрягает. Надо бы не 10, а 3, лучше повторить еще
...
### сортировка слов в списках лов уровня не работет 
Из-за того, что поля называются то valueSpelling, то valueSpelling.
Временно убрана сортировка слов