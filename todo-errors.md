...
**ВАЖНО!!!** Кнопка назад ведет себя неадекватно - не переходит назад, а выходит из программы

Кнопка фото: сделать посередине и круглую как в фотоаппарате

**ВАЖНО!!!** Фото: выбранное слово показывать перевод и меню к нему

Ориентация фото может быть горизонтальной

Неочевидно, что означает "скрыть"

Иконку "глаз" заменить на надпись

**ВАЖНО!!!** в поиске по слову точные совпадения вывести вперед

кнопка "сохранить" при редактировании - не нужна, сохранять автоматом

**ВАЖНО!!!** не ищет "mine", если ввести "mined"

**ВАЖНО!!!** не ищет "children", если ввести "children`s"
